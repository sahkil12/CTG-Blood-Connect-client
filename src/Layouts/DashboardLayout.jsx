     ...
     return (
          <div className="drawer lg:drawer-open">
               ...
               <div className="drawer-content flex flex-col">
                    {/* Top bar (mobile only) */}
                    <div className="navbar bg-gray-100/65 space-x-3 shadow-sm lg:hidden ">
               ...
               <div className="drawer-side">
                    ...
                    <aside className="w-72 min-h-full bg-[#fbfcfd] border-r border-neutral-300/80 flex flex-col justify-between pb-2">
                         <div>
                              {/* Sidebar Header */}
