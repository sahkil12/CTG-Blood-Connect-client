...
const cardDetails = [
  {
    ...
    subtitle: 'Register as a donor by filling up a simple form with your blood group, area and some details.'
  },
  {
    icon: FaSearch,
    title: 'Search Donors',
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-8">
          {cardDetails.map((card, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-white border border-gray-200 p-8 rounded-2xl text-center shadow-sm hover:shadow-xl transition duration-300 group"
              >
                {/* icon */}
