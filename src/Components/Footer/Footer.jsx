...
const Footer = () => {
     ...
     return (
          <footer className="footer rounded-t-3xl mx-auto footer-horizontal lg:w-[90%] footer-center bg-black text-white p-5 md:p-10">
               <aside className='w-full px-4 lg:px-28'>
